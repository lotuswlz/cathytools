...
public abstract class CustomizedRandomGenerator<T> {
    ...
    protected CustomizedRandomGenerator(CustomizedRandomSeeds<T> candidateItems) throws InvalidWeightException {
    ...
    public static <T> CustomizedRandomGenerator<T> getInstance(Class<T> cls, CustomizedRandomSeeds<T> candidateItems) throws InvalidGenericTypeException, InvalidWeightException {
